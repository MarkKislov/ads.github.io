...
},{"_css_loader":"../node_modules/parcel/src/builtins/css-loader.js"}],"index.ts":[function(require,module,exports) {
"use strict";
...
var pageHeight, scrollHeight, coefficient;

var setClipPath = function setClipPath(topWidth, bottomWidth, height) {
  if (topWidth === void 0) {
    topWidth = '40%';
  }
...
var setMagicTopWidth = function setMagicTopWidth() {
  return (scrollHeight / pageHeight * 100 * coefficient).toFixed() + '%';
};

var setMagicBottomWidth = function setMagicBottomWidth() {
  return (100 - scrollHeight / pageHeight * 100 * coefficient).toFixed() + '%';
};
...
window.addEventListener('load', function () {
  ...
  links$.forEach(function (link$) {
    link$.addEventListener('click', function () {
      var number = Number(link$.attributes['data-number'].value);
      window.scrollTo({
